          ...
          <React.Fragment>
            ...
            <MDBFooter className="font-small darken-3 pt-0 color-primary">
              ...
              <div className="footer-copyright text-center py-3">
                <MDBContainer fluid>
                  <div>&copy; {new Date().getFullYear()} Made with <MDBIcon fab icon="react" /> React and hosted on <MDBIcon icon="globe" /> Netlify by<a href="https://sreerajsree.netlify.app/"> Sreeraj S</a>
                </div>
                </MDBContainer>
              </div>
            </MDBFooter>
